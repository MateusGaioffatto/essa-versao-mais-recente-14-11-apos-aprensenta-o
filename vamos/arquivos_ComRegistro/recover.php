    ...
    try {
        ...
        if ($stmt->rowCount() == 1) {
            ...
            if ($emailSent) {
                ...
                header('Location: logi.php?message=' . urlencode('Erro ao enviar email. Tente novamente mais tarde.') . '&type=error');
            }
            exit();
        } else {
        ...
        header('Location: logi.php?message=' . urlencode('Erro no servidor. Tente novamente mais tarde.') . '&type=error');
        exit();
    }
} else {
